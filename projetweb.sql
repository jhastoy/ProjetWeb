...
--
-- Hôte : 127.0.0.1
-- Généré le :  Dim 17 mars 2019 à 16:36
...
INSERT INTO `games` (`TITLE`, `BODY`, `CONTENT`, `TYPE`, `ID_game`) VALUES
('Introduction', 'Ceci est l\'explication de l\'énigme, Blablablablanla', '<img src = \'test.png\'>', 2, 0);
...
INSERT INTO `scores` (`ID`, `progression`, `time`) VALUES
('jean', 0, '00:00:00'),
('', 0, '00:00:00');
